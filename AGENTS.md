...
Faz 0-28 (v1.0-v1.19) tamamlandı. Tam changelog (ne yapıldı, neden, canlı-kanıt) + araştırma-
onaylı backlog artık on-demand skill'de — her oturumda yüklenmez, gerektiğinde çağrılır:
`.claude/skills/ollamas-phase-history/SKILL.md`.
