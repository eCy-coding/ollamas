...
- **RFC 8707 resource-binding enforcement** (v1.16 adayı) — token `resource` saklanıyor ama `/mcp`'de doğrulanmıyor; çok-resource deploy'da gerekli (tek-resource'ta gereksiz).
