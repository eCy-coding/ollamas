...
leaders responsible for enforcement through the repository's **private vulnerability / security
advisory reporting**, or by contacting the maintainer directly. <!-- TODO(maintainer): add a direct
contact email here. -->
...
1. **Correction** — Community Impact: use of inappropriate language or other unprofessional behavior.
