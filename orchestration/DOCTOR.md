...
<!-- AUTO doctor.ts · 2026-06-24T10:44:04.915Z · GO · regenerate: tsx orchestration/bin/doctor.ts -->

## ✅ GO — 0-manuel tam canlı + taze

- [✓] **Claude Code hook'ları (SessionStart + model-hook)** — aktif
- [✓] **launchd autopilot agent (WatchPaths + periyodik)** — yüklü
- [✓] **Benchmark verisi tazeliği (en-verimli-seçim girdisi)** — taze (2026-06-24T09:29:47.821Z)
