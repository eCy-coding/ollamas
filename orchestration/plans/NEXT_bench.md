# NEXT — bench lane → (belirlenemedi — ROADMAP'e planlı versiyon ekle)
...
```
Sen bench lane sekmesisin (branch feat/v1.8-bench).

**[Context]** Sözleşmen: /Users/emrecnyngmail.com/Desktop/ollamas-v17-wt/AGENTS.md. Önce onu + SEYIR + errors_registry oku. Mevcut: ? DONE. Hedef: (belirlenemedi — ROADMAP'e planlı versiyon ekle).
