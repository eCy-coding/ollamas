...
- rounds: **5** · wave: 6 tasks/round · chaos: vision-down on even rounds, seeded repeat-failures, recurrence override
...
> Rerun: `tsx orchestration/bin/org-sandbox.ts --rounds 5`. Continuous: `--watch 600`.
