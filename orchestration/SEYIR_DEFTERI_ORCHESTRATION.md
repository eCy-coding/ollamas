...
> NOT (merge-union): yukarıdaki vO43 girdisiyle AYNI borç iki bağımsız hat tarafından eş-zamanlı kapatıldı
> (karargah headless loop ↔ bu req-sweep worktree kampanyası — yakınsak evrim). İki girdi de tarihçe olarak
> korundu (append-only ledger); tablolar örtüşür, çelişmez.
