...
describe("ToolRegistry choke-point", () => {
  test("exposes all 29 built-in workspace tools", () => {
    expect(ToolRegistry.schemas().length).toBe(29); // +bench_model(v1.8) +mac_power(v1.9) +eval_prompt(v1.12) +rag_index/rag_search(v1.13) +count_tokens(graft)
  });
