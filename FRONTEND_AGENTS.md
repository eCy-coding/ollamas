...
```yaml
SU_AN:    "vF8 — Real-time UX Polish (commit 010db54)"   # son shipped
SIRADAKI: "vF9 — i18n (@lingui TR/EN) + Theming (light/dark token) + tercih kalıcılığı"   # NEXT
UFUK:     "vF10 Observability & Self-Heal → vF11 Tenant-aware Cockpit → vF12 Billing & Usage UX"   # açık-uçlu, vF13+ eklenebilir
```
