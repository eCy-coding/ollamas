...
**DÜRÜST SINIR:** mekanizma 15 testle kanıtlı ve 19 aday canlı teklif ediliyor; ama canlı panel direktifi **üretmiyor**. Her uzman `askShared`'ın sistem prompt'u altında cevap veriyor ve o prompt terse çıktı dayatıyor ("Kaynaklarda cevap yoksa SADECE: BİLGİ_YOK"), fazladan satırı bastırıyor görünüyor. Zincir talep üzerine çalışıyor, kendiliğinden henüz tetiklenmedi. Deterministik tetikleyiciyle örtmek yerine böyle raporlanıyor — o, seçilenden başka bir tasarım olurdu.
